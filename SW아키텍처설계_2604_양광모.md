...
이 패턴은 학술적으로 Bass·Clements·Kazman의 *Software Architecture in Practice* 3판에서 **Shared-Data Pattern**이라는 이름으로 다뤄집니다.

**C&C(Component-and-Connector) 뷰의 대표 패턴**이고, 영속성·일관성·동시성을 저장소가 일괄 책임집니다. 가장 흔한 구현 형태는 **DBMS 중심 아키텍처**입니다.
