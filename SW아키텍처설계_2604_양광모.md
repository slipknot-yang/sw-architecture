...
### 2.3 코드 매핑 (Spring Boot)

> 2.1의 **3대 구성요소**가 Spring 코드의 어디에 있는지 1:1로 매핑.
...
//     "저장소"가 아니라 Data Accessor의 추상화 계층임 (2.4 참조)
```
...
### 3.1 ⭐ 일반적 DBMS 구성 — Repository Style의 표준 구현
...
### 3.2 ⭐ Git / GitHub — 이름 자체가 "Repository"
